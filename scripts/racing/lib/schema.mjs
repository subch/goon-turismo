...
//                                        // cls = class within a mixed grid (MotoAmerica, WRC)
//
//   Standing = {
...
export function result(fields) {
  return {
    ...
    cls: fields.cls ?? null, // class within a mixed grid (MotoAmerica "SBC", WRC "WRC2")
...
export function standingRow(fields) {
  return {
    ...
    // Series-specific columns, shown after Wins in insertion order
    // (NASCAR: playoff points, stage points, cutline...).
